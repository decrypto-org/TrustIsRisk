\subsection{Centrality}
  ...
  Trust Is Risk does not offer any realistic improvement over the existing centralized marketplaces model (e.g. ebay). We
  propose here some different measures to that end.
