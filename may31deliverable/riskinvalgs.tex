\section{Risk Invariance Algorithms}
  ...
  \end{equation}
  Due to the nature of these algorithms, the only inputs necessary are the initial flows $x_i$, the number $n$ and the desired
  flow reduction $V$. Proofs of correctness and complexity can be found in the Appendix.
