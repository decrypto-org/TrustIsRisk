\subsection{Common Setup}
  ...
  The game consists of $R$ rounds (blocks in bitcoin terms), the number of which is common knowledge for the players. The
...
resolveAllConflicts() :
  ...
  \noindent \texttt{resolveAllConflicts()} is executed after all players choose their moves for a round. Fig.~\ref{fig:game}
  depicts the evolution of a two-player game.
