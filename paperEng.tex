...
%\end{scope}
  ...
  \draw (156.0bp,104.5bp) node {10\bitcoin};
  ...
  \draw (156.0bp,148.5bp) node {3\bitcoin};
  ...
  \draw (73.5bp,162.5bp) node {6\bitcoin};
  ...
  \draw (73.5bp,135.5bp) node {5\bitcoin};
  ...
  \draw (156.0bp,172.5bp) node {2\bitcoin};
%
\end{tikzpicture}
     \end{center} \ \\
