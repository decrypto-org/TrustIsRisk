...
while (True)
  ...
  if ((*@$Loss_v$@*) == 0)
    ...
    \begin{proofsketch}
       ...
       total output. For the complete proof, kindly refer to the Appendix (\ref{maxflowgameproof}).
    \end{proofsketch}
    ...
    \begin{proofsketch}
       ...
       $A$ to $E$. For the complete proof, kindly refer to the Appendix (\ref{gameflowproof}).
    \end{proofsketch}
