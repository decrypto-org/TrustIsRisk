...
\end{tikzpicture}
   ...
   \section{Evolution of Trust}
     ...
     is played by $Player(j)$ respectively. A formal definition can be found in Appendix.
...
%    \end{lstlisting}
  ...
  \section{Trust Transitivity}
     ...
     whenever we use the Transitive Game. For the algorithm, see Appendix. An example follows:
\begin{center}
...
%       For the complete proof, see Appendix (proof \ref{convergenceproof}).
    ...
    Full proofs of all theorems and lemmas can be found in Appendix.
