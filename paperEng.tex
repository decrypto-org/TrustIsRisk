...
%        OLD PROOF END
    ...
    can invest any amount she chooses, thus she can arbitrarily set the direct trusts of any player in $\mathcal{C}$ to
    any player in $\mathcal{V}$ and can also steal all incoming direct trust to players in $\mathcal{C}$. Additionally, we
    give Eve a set of players $\mathcal{B}$ that she has corrupted (the corrupted set), so she fully controls their direct
    trusts to any player in $\mathcal{V}$ and can also steal all incoming direct trust to players in $\mathcal{B}$. The
    players $\mathcal{B}$ are considered to be legitimate before the corruption, thus they may be directly trusted by any
    player in $\mathcal{V}$. However, players $\mathcal{C}$ can be trusted only by players $\mathcal{B} \cup \mathcal{C}$
    but not by players $\mathcal{V} \setminus (\mathcal{B} \cup \mathcal{C})$.
%    In short,
%    \begin{equation}
