...
while (True)
  ...
  Turn = (*@$v$@*)Oracle((*@$\mathcal{G}_0$@*), (*@$v$@*), (*@$\left(\mathcal{H}\right)_{1 \dots j-1}$@*))
  ((*@$Turn_j$@*), NewCap) = validateTurn((*@$\mathcal{G}_{j-1}$@*), (*@$v$@*), (*@$Cap_{A, j-1}$@*), Turn)
  ((*@$G_j$@*), (*@$Cap_{v, j}$@*), (*@$H_j$@*)) = commitTurn((*@$\mathcal{G}_{j-1}$@*), (*@$v$@*), NewCap, (*@$Turn_j$@*))
    \end{lstlisting}
...
%    \end{lstlisting}
    The following algorithm validates that the tentative turn produced by the oracle respects the rules imposed on turns.
...
%    after turn 3. $B$ is happy until the end of turn 2 and sad after turn 3. The game converges in turn 4.
  \section{Trust Flow}
    ...
    \begin{proofsketch}
       ...
       trust.
%       For the complete proof, see Appendix (proof \ref{convergenceproof}).
    \end{proofsketch}
...
%       For the complete proof, see Appendix
    ...
    \begin{proofsketch}
       ...
       $A$ to $E$.
%       For the complete proof, see Appendix (proof \ref{gameflowproof}).
    \end{proofsketch}
...
%       For the complete proof, see Appendix (proof \ref{sybilproof}).
    \end{proofsketch}
  ...
  \section{Related Work}
     ...
     \cite{openrep,mui,fire,beta,core}, \cite{ghkkw,pace,rk,vpc,sdt,bazaar,wot,pathfinder} and in passing while working on
     other problems \cite{bitcoin}, \cite{beaver,synereo,dionyziz}. \cite{kmrs} gives a sociological justification for the
