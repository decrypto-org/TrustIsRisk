...
\end{scope}
  ...
  \draw [->] (Bob1) -- (Charlie1);
  \draw (199.0bp,64.5bp) node {\LARGE 20\bitcoin};
  \draw [->] (Alice2) -- (Bob2);
  \draw (394.0bp,64.5bp) node {\LARGE 10\bitcoin};
  \draw [->] (Alice1) -- (Bob1);
  \draw (95.0bp,64.5bp) node {\LARGE 10\bitcoin};
  \draw [->] (Bob2) -- (Charlie2);
  \draw (494.5bp,64.5bp) node {\LARGE 5\bitcoin};
%
