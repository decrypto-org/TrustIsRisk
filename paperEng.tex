...
%     that the whole platform will be discarded as untrusted by the scammed party.
     ...
     migrates her funds from P2PKH addresses \cite{bitcoinguide} to 1-of-2 multisig addreses shared with friends she
     ...
     function in a completely decentralized fashion will become clear in the following sections, along with the positive
     result that it is in principle Sybil resilient (\ref{sybil}).
...
%     \end{center}
     ...
     respectively. For a reference of common definitions, see Appendix.
...
%       \end{equation}
    ...
    fully decentralized autonomy. Let Eve be a possible attacker.
