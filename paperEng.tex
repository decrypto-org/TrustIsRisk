...
\begin{scope}
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  \draw (193.0bp,11.5bp) node {\textbf{Fig.7:} Graph $\mathcal{G}'$, as $\mathcal{G}$ with Auxiliary Source $T$. $\mathcal{S}$ is the set of sad players.};
\end{scope}
\begin{scope}
  \pgfsetstrokecolor{black}
  \definecolor{strokecol}{rgb}{1.0,1.0,1.0};
...
\begin{scope}
  ...
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  \draw (162.0bp,31.0bp) .. controls (162.0bp,31.0bp) and (298.0bp,31.0bp)  .. (298.0bp,31.0bp) .. controls (304.0bp,31.0bp) and (310.0bp,37.0bp)  .. (310.0bp,43.0bp) .. controls (310.0bp,43.0bp) and (310.0bp,148.0bp)  .. (310.0bp,148.0bp) .. controls (310.0bp,154.0bp) and (304.0bp,160.0bp)  .. (298.0bp,160.0bp) .. controls (298.0bp,160.0bp) and (162.0bp,160.0bp)  .. (162.0bp,160.0bp) .. controls (156.0bp,160.0bp) and (150.0bp,154.0bp)  .. (150.0bp,148.0bp) .. controls (150.0bp,148.0bp) and (150.0bp,43.0bp)  .. (150.0bp,43.0bp) .. controls (150.0bp,37.0bp) and (156.0bp,31.0bp)  .. (162.0bp,31.0bp);
  \draw (230.0bp,42.5bp) node {$\mathcal{G}$};
\end{scope}
  \node (A) at (185.0bp,80.0bp) [draw,ellipse] {A};
  \node (S) at (185.0bp,134.0bp) [draw,ellipse] {$\mathcal{S}$};
  \node (T) at (95.0bp,107.0bp) [draw,ellipse] {T};
  \node (G) at (255.0bp,107.0bp) [draw,ellipse] {$\mathcal{G} \setminus \left(\mathcal{S} \cup \{A\}\right)$};
  \draw [->] (A) ..controls (220.61bp,90.619bp) and (233.12bp,94.457bp)  .. (G);
  \draw [->] (S) ..controls (220.61bp,123.38bp) and (233.12bp,119.54bp)  .. (G);
  \draw [->] (T) ..controls (130.61bp,117.62bp) and (143.12bp,121.46bp)  .. (S);
  \draw [->] (T) ..controls (130.61bp,96.381bp) and (143.12bp,92.543bp)  .. (A);
%
\end{tikzpicture}
       \end{center}
