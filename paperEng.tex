...
%%
  ...
  \node (A) at (34.0bp,160.0bp) [draw,ellipse] {\semihuge A};
  \node (C) at (113.0bp,137.0bp) [draw,ellipse] {\semihuge C};
  \node (B) at (199.0bp,181.0bp) [draw,ellipse] {\semihuge B};
  \node (E) at (199.0bp,118.0bp) [draw,ellipse] {\semihuge E};
  \node (D) at (113.0bp,191.0bp) [draw,ellipse] {\semihuge D};
  \node (a1) at (428.99bp,283.0bp) [draw,ellipse] {\semihuge tx};
  \node (a3) at (428.99bp,161.0bp) [draw,ellipse] {\semihuge tx};
  \node (a2) at (428.99bp,222.0bp) [draw,ellipse] {\semihuge tx};
  \node (a5) at (428.99bp,39.0bp) [draw,ellipse] {\semihuge tx};
  \node (a4) at (428.99bp,100.0bp) [draw,ellipse] {\semihuge tx};
  ...
  \draw (488.99bp,89.5bp) node {\semihuge 1/\{C,B\}};
  \draw (488.99bp,109.5bp) node {\semihuge 3\bitcoin};
  \draw [->] (Z3) ..controls (377.14bp,161.0bp) and (392.28bp,161.0bp)  .. (a3);
  \draw (377.99bp,150.5bp) node {\semihuge C};
  \draw (377.99bp,170.5bp) node {\semihuge 10\bitcoin};
  \draw [->] (a3) ..controls (445.3bp,161.0bp) and (461.02bp,161.0bp)  .. (Y3);
  \draw (488.99bp,150.5bp) node {\semihuge 1/\{C,E\}};
  \draw (488.99bp,170.5bp) node {\semihuge 10\bitcoin};
  \draw [<->] (J1) ..controls (265.65bp,161.0bp) and (274.33bp,161.0bp)  .. (J2);
  \draw [->] (a2) ..controls (445.3bp,222.0bp) and (541.02bp,222.0bp)  .. (Y2);
  \draw (488.99bp,211.5bp) node {\semihuge 1/\{A,D\}};
  \draw (488.99bp,231.5bp) node {\semihuge 6\bitcoin};
  ...
  \draw (156.0bp,127.5bp) node {\semihuge 10\bitcoin};
  \draw [->] (a5) ..controls (445.3bp,39.0bp) and (541.02bp,39.0bp)  .. (Y5);
  \draw (488.99bp,28.5bp) node {\semihuge 1/\{D,B\}};
  \draw (488.99bp,48.5bp) node {\semihuge 2\bitcoin};
  \draw [->] (C) ..controls (142.79bp,152.08bp) and (162.28bp,162.29bp)  .. (B);
  \draw (156.0bp,170.5bp) node {\semihuge 3\bitcoin};
  \draw [->] (Z5) ..controls (377.14bp,39.0bp) and (392.28bp,39.0bp)  .. (a5);
  \draw (377.99bp,28.5bp) node {\semihuge D};
  \draw (377.99bp,48.5bp) node {\semihuge 2\bitcoin};
  \draw [->] (Z2) ..controls (377.14bp,222.0bp) and (392.28bp,222.0bp)  .. (a2);
  \draw (377.99bp,211.5bp) node {\semihuge A};
  \draw (377.99bp,231.5bp) node {\semihuge 6\bitcoin};
  \draw [->] (A) ..controls (62.311bp,171.0bp) and (77.709bp,177.19bp)  .. (D);
  \draw (73.5bp,187.5bp) node {\semihuge 6\bitcoin};
  \draw [->] (a1) ..controls (445.3bp,283.0bp) and (541.02bp,283.0bp)  .. (Y1);
  \draw (488.99bp,272.5bp) node {\semihuge 1/\{A,C\}};
  \draw (488.99bp,292.5bp) node {\semihuge 5\bitcoin};
  \draw [->] (Z4) ..controls (377.14bp,100.0bp) and (392.28bp,100.0bp)  .. (a4);
  \draw (377.99bp,89.5bp) node {\semihuge C};
  \draw (377.99bp,109.5bp) node {\semihuge 3\bitcoin};
  \draw [->] (A) ..controls (62.483bp,151.79bp) and (77.403bp,147.33bp)  .. (C);
  \draw (73.5bp,157.5bp) node {\semihuge 5\bitcoin};
  \draw [->] (Z1) ..controls (377.14bp,283.0bp) and (392.28bp,283.0bp)  .. (a1);
  \draw (377.99bp,272.5bp) node {\semihuge A};
  \draw (377.99bp,292.5bp) node {\semihuge 5\bitcoin};
  \draw [->] (D) ..controls (143.64bp,187.47bp) and (161.02bp,185.4bp)  .. (B);
  \draw (156.0bp,194.5bp) node {\semihuge 2\bitcoin};
  \draw (270.5bp,0.0bp) node {\semihuge \textbf{Fig.3:} TrustIsRisk Game Graph and Equivalent Bitcoin UTXO};
%
\end{tikzpicture}
