...
%, $N^{+}\left(A\right)_j, N^{-}\left(A\right)_j, N\left(A\right)_j$] \ 
     ...
     \begin{enumerate}
        ...
        \end{equation}
        \item \begin{equation}
           Turn_{j_2} = \{Steal\left(y, B\right), Add\left(w, B\right)\} \enspace,
        \end{equation}
        given that
        \begin{equation}
        ...
        \end{equation}
        where $A = Player\left(j_2\right)$.
        \item \begin{equation}
           Turn_{j_3} = \{Steal\left(x, B\right), Add\left(y, C\right), Add\left(w, D\right)\} \enspace,
        \end{equation}
        given that
        \begin{equation}
        \begin{gathered}
        ...
        \end{gathered}
        \end{equation}
        where $A = Player\left(j_3\right)$.
        \item \begin{equation}
           Turn_{j_4} = \{Steal\left(x, B\right), Steal\left(y, B\right)\}
        \end{equation}
        ...
        \begin{equation}
           Turn_{j_4} = \{Steal\left(x+y, B\right)\} \enspace,
        \end{equation}
        where $A = Player\left(j_4\right)$.
     \end{enumerate}
