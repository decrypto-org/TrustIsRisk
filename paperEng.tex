...
\institute{National Technical University of Athens, National and Kapodistrian University of Athens \\
...
while (True)
  ...
  if ((*@$v$@*) != (*@$E$@*))
    ...
    let $j' = prev\left(j\right)$ and $\{v_1, \dots, v_k\} = N^{-}\left(A\right)_j$. Given that
    \begin{equation}
    ...
    \begin{equation}
       Turn_j =
         \begin{cases}
            ...
            \bigcup\limits_{i=1}^{k}\{Steal\left(y_i,v_i\right)\}, & Damage_{v, j} > 0
         \end{cases} \enspace.
    \end{equation}
    In the second case, it is
    \begin{equation}
       \sum\limits_{i=1}^{k}y_i = \min\left(in_{v, j-1}, Damage_{v, j}\right) \enspace.
    \end{equation}
