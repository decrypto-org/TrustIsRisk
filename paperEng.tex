...
\end{tikzpicture}
  ...
  \section{Further Research}
     ...
     \subsection{Trust Transfer Algorithms}
        A future paper will address the issue of the method that a client will use to rearrange her direct outgoing trust so
        that the indirect trust to the vendor remains invariant before and after depositing the funds needed for the
        purchase, thus fulfilling the supposition (\ref{primetrust}) of Risk Invariance Theorem.
     ...
     \subsection{Dynamic Setting}
        ...
        the dynamic setting, users should be able to play simultaneously, freely join, leave and disconnect temporarily from
        the network.
     ...
     \subsection{Implementation}
        We are proposing a concrete game and not a theoretical concept. Thus its implementation as a wallet on any blockchain
     ...
     \subsection{Alternative Multisigs}
        ...
        the trust relations that can arise by using other types of multisig, such as 1-of-3, as vehicle for multi-party trust
        schemes. Our results do not necessarily hold and the simple relations now represented by directed weighted graphs
        have to be revised under a new kind of representation.
