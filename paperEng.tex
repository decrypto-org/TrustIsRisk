...
idleOracle((*@$\mathcal{G}_{j-1}$@*)) : (*@\Reactivatenumber@*)
  return((*@$\emptyset$@*))
     ...
     \begin{definition}[Evil Strategy] \ \\
        ...
        direct trust in her turn. We note that $N(A)_{j-1} = N(A)_j$.
     \end{definition}
     \Suppressnumber
...
evilOracle((*@$\mathcal{G}_{j-1}$@*)) : (*@\Reactivatenumber@*)
  ...
  return((*@$Turn_j$@*))
     ...
     \begin{definition}[Conservative Strategy] \ \\
        ...
        from others that trust her as much as she can up to $x$ and she takes no other action. We note that
        $N\left(A\right)_{j-1} = N\left(A\right)_j$.
     \end{definition}
     \Suppressnumber
...
consOracle((*@$\mathcal{G}_{j-1}$@*)) : (*@\Reactivatenumber@*)
  ...
  if (Damage > 0)
    if (Damage >= (*@$in_{A, j-1}$@*))
      ...
      (*@$Turn_j$@*) = (*@$\bigcup\limits_{v \in N^{-}\left(A\right)}\{Steal\left(y_v, v\right)\}$@*)
  else
    (*@$Turn_j$@*) = (*@$\emptyset$@*)
  return((*@$Turn_j$@*))
     \end{lstlisting}
     ...
     \begin{equation}
        ...
        y_v \leq DTr_{v \rightarrow A} \enspace.
     \end{equation}
