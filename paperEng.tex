...
\begin{scope}
  ...
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  \draw (183.0bp,213.5bp) node {\Large $\mathcal{G}_0$};
\end{scope}
  \node (E3) at (192.0bp,280.0bp) [draw,ellipse] {\Large E};
  \node (E2) at (423.0bp,284.0bp) [draw,ellipse,very thick] {\Large E};
  \node (D2) at (344.0bp,309.0bp) [draw,ellipse] {\Large D};
  \node (D3) at (113.0bp,324.0bp) [draw,ellipse] {\Large D};
  \node (A1) at (34.0bp,114.0bp) [draw,ellipse] {\Large A};
  \node (A0) at (265.0bp,114.0bp) [draw,ellipse] {\Large A};
  \node (A3) at (34.0bp,314.0bp) [draw,ellipse] {\Large A};
  \node (A2) at (265.0bp,290.0bp) [draw,ellipse] {\Large A};
  \node (B0) at (265.0bp,60.0bp) [draw,ellipse] {\Large B};
  \node (B1) at (34.0bp,60.0bp) [draw,ellipse] {\Large B};
  \node (B2) at (265.0bp,236.0bp) [draw,ellipse] {\Large B};
  \node (B3) at (34.0bp,251.0bp) [draw,ellipse] {\Large B};
  \node (C3) at (113.0bp,270.0bp) [draw,ellipse] {\Large C};
  \node (C2) at (344.0bp,255.0bp) [draw,ellipse] {\Large C};
  ...
  \draw [->] (A3) ..controls (62.101bp,298.51bp) and (78.735bp,289.01bp)  .. (C3);
  \draw (73.5bp,301.5bp) node {\Large 6\bitcoin};
  \draw [->] (A1) ..controls (62.101bp,101.65bp) and (78.735bp,84.41bp)  .. (C1);
  \draw (73.5bp,105.5bp) node {\Large 6\bitcoin};
  \draw [->] (A2) ..controls (293.71bp,296.84bp) and (308.24bp,300.42bp)  .. (D2);
  \draw (304.5bp,308.5bp) node {\Large 3\bitcoin};
  \draw [->] (A0) ..controls (293.17bp,101.65bp) and (309.1bp,84.41bp)  .. (C0);
  \draw (304.5bp,105.5bp) node {\Large 4\bitcoin};
  \draw [->] (B3) ..controls (59.732bp,249.52bp) and (68.942bp,249.95bp)  .. (77.0bp,252.0bp) .. controls (82.045bp,253.28bp) and (87.187bp,255.4bp)  .. (C3);
  \draw (73.5bp,259.5bp) node {\Large 7\bitcoin};
  \draw [->] (B2) ..controls (290.73bp,234.52bp) and (299.94bp,234.95bp)  .. (308.0bp,237.0bp) .. controls (313.04bp,238.28bp) and (318.19bp,240.4bp)  .. (C2);
  \draw (304.5bp,244.5bp) node {\Large 7\bitcoin};
  \draw [->] (A2) ..controls (293.17bp,277.65bp) and (309.1bp,270.41bp)  .. (C2);
  \draw (304.5bp,281.5bp) node {\Large 6\bitcoin};
  \draw [->] (C3) ..controls (141.95bp,273.63bp) and (156.16bp,275.48bp)  .. (E3);
  \draw (152.5bp,283.5bp) node {\Large 3\bitcoin};
  \draw [->] (D3) ..controls (141.1bp,308.51bp) and (157.73bp,299.01bp)  .. (E3);
  \draw (152.5bp,311.5bp) node {\Large 4\bitcoin};
  \draw [->] (A3) ..controls (62.955bp,317.63bp) and (77.158bp,319.48bp)  .. (D3);
  \draw (73.5bp,326.5bp) node {\Large 3\bitcoin};
