...
%       \SetKwInOut{Output}{Output}
    ...
    \begin{proof}
       ...
       the total loss is constant and equal to the total value stolen by $E$. Also, we can see in lines 3 and 29, which are
       ...
       j \geq j_1, out_{A, j} = out_{A, j_0}$. \\ In $Turn_{j_1}$, $v$ steals $St_{j_1} = \sum\limits_{i=1}^{m}y_i$. Thus
