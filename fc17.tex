...
%       For the complete proof, see the Appendix (proof \ref{sybilproof}).
  ...
  \section{Further Research}
     ...
     %\subsection{Dynamic Setting}
        ...
        disconnect temporarily from the network.
     ...
     %\subsection{Experimental Results}
        ...
        decisions about theoretical approaches, design choices and investment strategies. Once experimental results are
        established, our trust network can be used in other applications, such as decentralized social networks \cite{synereo}.
