\section{Centrality}
  ...
  \subsection{Degree Centrality}
    ...
    \addtocounter{footnote}{-1} direct\footnotemark direct trust of $\mathcal{G}$; $\max C^d_{out}$ is defined equivalently.

    \begin{equation*}
      C^{mF}\left(A\right) = \sum\limits_{B,C \in \mathcal{V} \setminus \{A\}}\left(Tr_{\mathcal{G}, B \rightarrow C} -
