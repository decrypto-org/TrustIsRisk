\section{Related Work}
  ...
  The discussion in \cite{synereo} does not revolve around trust, but it aims to describe a decentralized social network.
  As a result, trust is not rigorously defined, but reputation is and its measure is called \texttt{Reo}. Risking
