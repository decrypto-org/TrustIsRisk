\section{Trust Transitivity}
  ...
  nothing has been stolen yet (see \ifdefined\proceedings the Conservative World theorem in Appendix A \cite{trustisrisk}\else
  Appendix A (Theorem~\ref{conservativeworld})\fi \ for a formal proof of this simple fact). Moreover, let $v = Player(j)$.
