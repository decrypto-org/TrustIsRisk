\section{Trust Flow}
  ...
  Full proofs of all theorems and lemmas can be found in Appendix A\ifdefined\proceedings \ of the full version of Trust Is
  Risk \cite{trustisrisk}\fi.
  ...
  \subimport{fc17/proofs/}{trustflowproof.tex}
